<template>
    ...
    <el-dialog
      ...
      <div v-loading="loading">
        ...
        <div class="table-operation d-flex">
          ...
          <el-button type="success" plain @click="dialogVisible = false">选中</el-button>
        </div>
        <!--    添加的表格-->
        <el-table
          ...
          <el-table-column property="tagname" label="测点名" header-align="center" show-overflow-tooltip/>
          <el-table-column property="desp" label="描述" header-align="center" show-overflow-tooltip/>
          <el-table-column property="max" label="量程上线" header-align="center"/>
          <el-table-column property="min" label="量程下线" header-align="center"/>
          <el-table-column property="name" label="数据值" header-align="center"/>
          <el-table-column property="name" label="数据时间" header-align="center"/>
          <el-table-column property="max" label="最大值" header-align="center"/>
          <el-table-column property="min" label="最小值" header-align="center"/>
          <el-table-column property="name" label="平均值" header-align="center"/>
        </el-table>
        <!--      分页-->
        <div class="mt">
          <el-pagination
  ...
  <div v-if="data.pointTableData.length !== 0" class="d-flex jc-center mt">
    <el-table
      ...
      <el-table-column property="name" label="测点名" header-align="center"/>
      <el-table-column property="name" label="描述" header-align="center"/>
      <el-table-column property="name" label="量程上线" header-align="center"/>
      <el-table-column property="name" label="量程下线" header-align="center"/>
      <el-table-column property="name" label="数据值" header-align="center"/>
      <el-table-column property="name" label="数据时间" header-align="center"/>
      <el-table-column property="name" label="最大值" header-align="center"/>
      <el-table-column property="name" label="最小值" header-align="center"/>
      <el-table-column property="name" label="平均值" header-align="center"/>
...
<script setup>
  ...
  //引入封装的接口
  import {getTagInfoSiteAll, getData} from '../request/getData'
  ...
  const search = async () => {
    ...
    let {data: tableAll, total: totals, pageSize} = await getData(form)
    total.value = totals
    paging.pageSize = pageSize
    data.tableData=tableAll
    loading.value = false
